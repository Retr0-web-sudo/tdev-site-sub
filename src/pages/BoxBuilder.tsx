...
import { ArrowLeft, ArrowRight, Check, Package, Loader2, ShoppingBag, X, Sparkles, Star, Crown } from "lucide-react";
...
const BoxBuilder = () => {
  ...
  const handleConfirm = async () => {
    ...
    setSubmitting(true);
    try {
      // Save quiz + items, then go to checkout
      ...
      // Store box data in sessionStorage for checkout
  ...
  return (
    <div className="min-h-screen bg-background">
      <Seo title="Build Your Box — TDEV Closet" description="Pick the outfits you want in your monthly subscription box." path="/subscription/build-box" />
      <Navbar />
        ...
        <div className="max-w-6xl mx-auto">
          <motion.div className="text-center mb-8" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="font-display text-3xl sm:text-4xl font-light text-foreground">
              Build Your <span className="italic text-accent">Monthly Box</span>
            </h1>
