...
const Admin = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[hsl(0_0%_7%)] flex flex-col items-center justify-center gap-6">
        <img src="/logo.png" alt="TDEV | Tenue de Ville" className="h-12 w-12 rounded-lg object-cover ring-1 ring-white/10" />
  ...
  if (!isAdmin) {
    return (
      <div className="min-h-screen bg-[hsl(0_0%_7%)] flex flex-col items-center justify-center gap-4 section-padding">
        <img src="/logo.png" alt="TDEV | Tenue de Ville" className="h-14 w-14 rounded-lg object-cover ring-1 ring-white/10 mb-2" />
