...
-- Site settings (themes, fonts, content)
...
INSERT INTO public.categories (name, slug, description, display_order) VALUES
  ('Femme', 'femme', 'Spring / Summer 2026', 1),
  ('Homme', 'homme', 'Essentials', 2),
  ('Global', 'global', 'New Arrivals', 3);

-- Insert default site settings
INSERT INTO public.site_settings (key, value) VALUES
  ('theme', '{"mode": "light", "primaryColor": "#8B6914", "fontDisplay": "Cormorant Garamond", "fontBody": "Outfit"}'),
  ('philosophy', '{"title": "Rooted in Nature, Refined by Design", "content": "TDEV is a celebration of natural materials and timeless craftsmanship."}'),
  ('hero', '{"title": "TDEV", "subtitle": "Global Collection", "cta": "Explore"}');
